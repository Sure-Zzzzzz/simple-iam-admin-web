...
export const TRUSTED_APPLICATION_ICONS = [
...
export type TrustedApplicationIconCode = typeof TRUSTED_APPLICATION_ICONS[number]['code'];

export function isTrustedApplicationIconCode(value: string): value is TrustedApplicationIconCode {
  return TRUSTED_APPLICATION_ICONS.some(icon => icon.code === value);
}
